...
namespace Linq.Tests
{
    ...
    public class SortingDataTests
    {
        ...
        {
            string[] expected = {"apple", "blueberry", "cherry"};
            CollectionAssert.AreEqual(expected, OrderBy());
        }

        [Test]
        public void OrderByPropertyTest()
        {
            string[] expected = {"apple", "cherry", "blueberry"};
            CollectionAssert.AreEqual(expected, OrderByProperty());
        }

        [Test]
        public void OrderByProductsTest()
        {
            Product[] expected =
            {
                new Product
            ...
            CollectionAssert.AreEqual(expected, OrderByProducts());
        }

        [Test]
        public void OrderByWithCustomComparerTest()
        {
            string[] expected =
            {
                "AbAcUs", "aPPLE", "BlUeBeRrY", "bRaNcH", "cHeRry", "ClOvEr",
            };
            CollectionAssert.AreEqual(expected, OrderByWithCustomComparer());
        }

        [Test]
        public void OrderByDescendingTest()
        {
            double[] expected = {4.1, 2.9, 2.3, 1.9, 1.7,};
            CollectionAssert.AreEqual(expected, OrderByDescending());
        }

        [Test]
        public void OrderProductsDescendingTest()
        {
            Product[] expected =
            {
                new Product
            ...
            CollectionAssert.AreEqual(expected, OrderProductsDescending());
        }

        [Test]
        public void DescendingCustomComparerTest()
        {
            string[] expected =
            {
                "ClOvEr", "cHeRry", "bRaNcH", "BlUeBeRrY", "aPPLE", "AbAcUs"
            };
            CollectionAssert.AreEqual(expected, DescendingCustomComparer());
        }
        ...
        public void ThenByTest()
        {
            ...
            CollectionAssert.AreEqual(expected, ThenBy());
        }

        [Test]
        public void ThenByCustomTest()
        {
            string[] expected =
            {
                "aPPLE", "AbAcUs", "bRaNcH", "cHeRry", "ClOvEr", "BlUeBeRrY",
            };
            CollectionAssert.AreEqual(expected, ThenByCustom());
        }

        [Test]
        public void ThenByDifferentOrderingTest()
        {
            Product[] expected =
            {
                new Product
            ...
            CollectionAssert.AreEqual(expected, ThenByDifferentOrdering());
        }

        [Test]
        public void CustomThenByDescendingTest()
        {
            string[] expected =
            {
                "aPPLE", "ClOvEr", "cHeRry", "bRaNcH", "AbAcUs", "BlUeBeRrY"
            };
            CollectionAssert.AreEqual(expected, CustomThenByDescending());
        }

        [Test]
        public void OrderingReversalTest()
        {
            string[] expected =
            {
                "nine", "eight", "six", "five"
            };
            CollectionAssert.AreEqual(expected, OrderingReversal());
        }
    }
}